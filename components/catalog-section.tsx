        ...
        <div className="container relative z-10 px-4 md:px-6 mx-auto">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 md:gap-6 max-w-6xl mx-auto">
            {categories.map((category, idx) => {
              ...
              <Card 
                key={category.id} 
                className={`overflow-hidden hover:shadow-2xl hover:shadow-accent/20 transition-all duration-500 hover:scale-[1.03] hover:-translate-y-2 hover:border-accent/50 group animate-in fade-in slide-in-from-bottom-8 duration-700 cursor-pointer ${isLast ? 'col-span-1 lg:col-span-1' : ''}`}
